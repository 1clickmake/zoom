...
$sql_common = " from g5_write_teacher_info ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="th_hit">Country</th>
        <th scope="col" id="th_hit">State or City</th>
        <th scope="col" id="th_mng">service experience</th>
		<th scope="col" id="th_mng">write</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_mng" class="td_mng td_mns_m">
            <a href="./teacher_view.php?wr_id=<?php echo $row['wr_id']; ?>" class="btn btn_03">View</a>
        </td>
    </tr>
