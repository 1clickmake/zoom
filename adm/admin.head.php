...
<header id="hd">
    ...
    <div id="hd_top" class="clearfix">
		...
		<div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" ><?php echo get_text($config['cf_title']); ?></a></div>
            ...
            foreach($amenu as $key=>$value) {
                ...
                if (isset($menu['menu'.$key][0][2]) && $menu['menu'.$key][0][2]) {
                    $href1 = $menu['menu'.$key][0][2];
                } else {
                    $href1 = "#";
                }
				
				if (isset($menu['menu'.$key][0][4]) && $menu['menu'.$key][0][4]) {
					$icons = $menu['menu'.$key][0][4];
				}else{
					$icons = 'folder-open-o';
				}
            ...
            ?>
				<a href="<?php echo $href1?>" class="inline-block btn btn_02 bg-dark mt-2 ml-2 rounded-0 text-light" title="<?php echo $button_title; ?>"><i class="fa fa-<?php echo $icons?>"></i> <?php echo $button_title;?></a>
			<?php
            $jj++;
            }     //end foreach
            ?>
            ...
            <ul>
                ...
                <li class="tnb_li"><button type="button" class="tnb_mb_btn">관리자<span class="./img/btn_gnb.png">메뉴열기</span></button>
                    <ul class="tnb_mb_area ">
                        <li><a href="<?php echo G5_ADMIN_URL ?>/member_form.php?w=u&amp;mb_id=<?php echo $member['mb_id'] ?>" class="text-dark">관리자정보</a></li>
                        <li id="tnb_logout"><a href="<?php echo G5_BBS_URL ?>/logout.php"  class="text-dark">로그아웃</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <nav id="gnb" class="gnb_large <?php echo $adm_menu_cookie['gnb']; ?>">
        ...
        <ul class="gnb_ul">
            ...
            <li class="gnb_li<?php echo $current_class;?>">
                <a href="#" class="btn_op menu-<?php echo $key; ?>  menu-order-<?php echo $jj; ?> bg-dark text16" title="<?php echo $button_title; ?>"><i class="fa fa-<?php echo $icons?>"></i></a>
                <div class="gnb_oparea_wr">
                    <div class="gnb_oparea">
                        <h3 class="text-light"><?php echo $menu['menu'.$key][0][1];?></h3>
