<?php
$menu['menu100'] = array (
    array('100000', '환경설정', G5_ADMIN_URL.'/config_form.php', 'config', 'cog'),
	
	array('100000', '<b class="arrcolor"><i class="fa fa-check-square-o"></i> 환경설정</b>', '#', 'line', 1),
    array('100100', '기본환경설정', G5_ADMIN_URL.'/config_form.php',   'cf_basic'),
	
    //array('100200', '관리권한설정', G5_ADMIN_URL.'/auth_list.php',     'cf_auth'),
	//array('100000', '<b class="arrcolor"><i class="fa fa-check-square-o"></i> 디자인관리</b>', '#', 'line', 1),
	...
	array('100000', '<b class="arrcolor"><i class="fa fa-check-square-o"></i> 관리</b>', '#', 'line', 1),
