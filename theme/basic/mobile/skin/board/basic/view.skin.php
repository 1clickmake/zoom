...
include_once($board_skin_path.'/_naver_view.lib.php');
...
<article id="bo_v" class="bg-light container-fluid pb-5">
    <header>
        <h5>
    ...
    <section id="bo_v_info" class="mt-2">
        <h2>페이지 정보</h2>
    ...
    <div>
		...
		<div class="row">
			...
			<div class="btn-group" role="group" aria-label="Basic example">
				...
				<?php if ($copy_href) { ?><a href="<?php echo $copy_href ?>" class="btn btn-outline-danger text14" onclick="board_move(this.href); return false;"><i class="fa fa-files-o"></i> 복사</a><?php } ?>
				<?php if ($move_href) { ?><a href="<?php echo $move_href ?>" class="btn btn-outline-danger text14" onclick="board_move(this.href); return false;"><i class="fa fa-arrows"></i> 이동</a><?php } ?>
				<?php if ($search_href) { ?><a href="<?php echo $search_href ?>" class="btn btn-outline-danger text14"><i class="fa fa-search"></i> 검색</a><?php } ?>
			</div>
			</div>
			...
			<div class="btn-group" role="group" aria-label="Basic example">
			   <a href="<?php echo $list_href ?>" class="btn btn-outline-secondary text14"><i class="fa fa-list"></i> 목록</a>
				<?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="btn btn-outline-secondary text14"><i class="fa fa-reply"></i> 답변</a><?php } ?>
				<?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn btn-primary text14"><i class="fa fa-pencil"></i> 글쓰기</a><?php } ?>
			</div>
			</div>
		</div>
