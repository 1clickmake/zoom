...
?>
<script src="<?php echo $board_skin_url?>/jquery.inview.min.js"></script>
<style>
...
<!-- 게시판 목록 시작 -->
    ...
    <div id="response" class="row">
		...
		<div style="width:0:; height:0; overflow:hidden;"><img id="loader" src="<?php echo $board_skin_url?>/img/loader.gif"></div>
         ...
         $(document).ready(function(){
             ...
             $('#loader').on('inview', function(event, isInView) {
                 if (isInView) {
                     ...
                     $.ajax({
                         type: 'POST',
                         url: '<?php echo $board_skin_url?>/pagination.php',
                         data: { 
							pageno: nextPage,
							board_path : '<?php echo $board_skin_path?>',
