...
<div class="register container">
	...
	<input type="hidden" name="mbtype" value="<?php echo $mbtype?>">
    ...
    <input type="hidden" name="mb_1" value="<?php if($w == "") echo $mbtype; else echo $member['mb_1'];?>"><!--member type-->

    <div class="form_01">
        <h2 class="d-none">사이트 이용정보 입력</h2>
        <ul>
	        <li>
    ...
    <div class="form_01">  
		...
		<ul>
	        ...
	        <li class="reg_mb_img_file filebox d-none">
    ...
    <div class="btn_confirm text2_0" >
        <a href="<?php echo G5_URL; ?>/" class="btn_cancel">Cancle</a>
        <button type="submit" id="btn_submit" class="btn_submit" accesskey="s"><?php echo $w==''?'Join':'Modify'; ?></button>
    </div>
    </form>
